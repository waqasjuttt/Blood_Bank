...
public class ResetPassword_Fragment extends Fragment implements View.OnClickListener {
    ...
    private void CheckValidation() {
        ...
        if (et_password.getText().toString().isEmpty()) {
            et_password.setError("Enter your new password.");
...
//                    TastyToast.LENGTH_SHORT, TastyToast.SUCCESS).show();
                ...
                progressDialog.setMessage("Updating user password...");
                progressDialog.show();
                progressDialog.setCanceledOnTouchOutside(false);
                StringRequest stringRequest = new StringRequest(Request.Method.POST,
                        Paths.UPDATE_PASSWORD_URL,
